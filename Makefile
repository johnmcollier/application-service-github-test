...
# redhat.com/application-service-bundle:$VERSION and redhat.com/application-service-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/jcollier/application-service
...
CATALOG_IMG ?= $(IMAGE_TAG_BASE)-catalog:$(TAG_NAME)
